...
<html lang="sv"> 
	...
	<?php endif; ?>
            ...
            <form name="myForm" onsubmit="return validateForm()" method="post">
                   ...
                   <div class="sökfält" data-name="sökfält">
                   </div>
